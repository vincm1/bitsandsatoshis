import { A as AstroError, N as NoImageMetadata, U as UnsupportedImageFormat, H as MissingSharp } from './entrypoint_7hSRLVHs.mjs';
import { b as baseService, d as detector, r as resolveDefaultOutputFormat, p as parseQuality } from './generic_BsXQFahE.mjs';
...
async function loadSharp() {
  let sharpImport;
  try {
    sharpImport = (await import('./index_XsoqdExd.mjs').then(n => n.i)).default;
  } catch {
